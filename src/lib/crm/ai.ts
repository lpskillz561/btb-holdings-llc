...
- Passive activity rules are the most common reason a modelled deduction fails to offset a client's actual income. Long-term rentals are generally passive. Short-term rentals escape that only with an average stay of seven days or less AND material participation. Raise this rather than waiting to be asked.
